...
const card =
	"rounded-lg border border-white/15 bg-white/[0.08] p-3 shadow-lg shadow-black/5 backdrop-blur-md";

//TODO: Add charts
export const UIPattern = (): React.ReactElement => {
	return (
		<div className="absolute inset-0 bg-[oklch(0.38_0.09_186)]">
			<div className="absolute -inset-x-4 -inset-y-10 flex items-center justify-center">
