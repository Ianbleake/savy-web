			...
			<div className="absolute -inset-x-3 -inset-y-20 flex items-center justify-center">
				<div className="grid w-185 -rotate-3 grid-cols-3 gap-3">
					...
					<div className={card}>
						...
						<div className="mt-0.5 flex items-center gap-1 text-[10px] text-emerald-300">
					...
					<div className={card}>
						...
						<div className="mt-0.5 flex items-center gap-1">
							...
							<ArrowUp className="size-2.5 text-emerald-300" />
						</div>
					</div>
					...
					<div className={card}>
						...
						<p className="mt-0.5 text-lg font-bold text-emerald-300">74%</p>
						<div className="mt-1 h-1 w-full overflow-hidden rounded-full bg-white/10">
							<div className="h-full w-[74%] rounded-full bg-emerald-400/60" />
						</div>
					</div>
					...
					<div className={card}>
						<div className="flex items-center gap-2">
							<div className="size-5 rounded-full bg-white/10" />
							<p className="text-[11px] text-emerald-300">+$15,000</p>
						</div>
					</div>
					...
					<div className={`${card} col-span-2`}>
						...
						<div className="mt-1.5 h-1.5 w-full overflow-hidden rounded-full bg-white/10">
							<div className="h-full w-[45%] rounded-full bg-emerald-400/60" />
						</div>
					...
					<div className={card}>
						...
						<p className="mt-0.5 text-lg font-bold text-emerald-300">48%</p>
						<div className="mt-1 h-1 w-full overflow-hidden rounded-full bg-white/10">
							<div className="h-full w-[48%] rounded-full bg-emerald-400/60" />
						</div>
					</div>
					...
					<div className={`${card} col-span-2`}>
						...
						<div className="mt-1.5 h-1.5 w-full overflow-hidden rounded-full bg-white/10">
							<div className="h-full w-[82%] rounded-full bg-emerald-400/60" />
						</div>
					...
					<div className={card}>
						...
						<p className="mt-0.5 text-lg font-bold text-emerald-300">91%</p>
						<div className="mt-1 h-1 w-full overflow-hidden rounded-full bg-white/10">
							<div className="h-full w-[91%] rounded-full bg-emerald-400/60" />
						</div>
					</div>
					...
					<div className={card}>
						<div className="flex items-center gap-2">
							<div className="size-5 rounded-full bg-white/10" />
							<p className="text-[11px] text-emerald-300">+$5,400</p>
						</div>
					</div>
